...
import com.example.project_chachacha.template.src.Mypage.StoreShop.StoreShop_adapter;
import com.example.project_chachacha.template.src.Mypage.StoreShop.StoreShop_item;

import java.util.ArrayList;

public class ChaChaCha2_adapter extends RecyclerView.Adapter<ChaChaCha2_adapter.CustomViewHolder> {
    private Context context;
    private ArrayList<StoreShop_item> arrayList;

    public ChaChaCha2_adapter(Context context, ArrayList<StoreShop_item> arrayList) {
    ...
    @NonNull
    @Override
    public ChaChaCha2_adapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chachacha_item,parent,false);

        ChaChaCha2_adapter.CustomViewHolder viewHolder = new ChaChaCha2_adapter.CustomViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull ChaChaCha2_adapter.CustomViewHolder holder, int position) {
